...
# demo_airflow_docker_compose documentation build
...
from demo_airflow_docker_compose import __version__ as release

# -- Project information -----------------------------------------------------

project = "demo_airflow_docker_compose"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "demo_airflow_docker_composedoc"
...
latex_documents = [
    (
        master_doc,
        "demo_airflow_docker_compose.tex",
        "demo_airflow_docker_compose Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "demo_airflow_docker_compose",
        "Project demo_airflow_docker_compose codebase.",
        "Data-Science",
    )
]
